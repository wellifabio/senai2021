...
arquivo.write("Cidade;UF;Funcionario;Salario;Produto;Preço\r\n");
for mes in meses:
  for cidade in cidades:
    for i in range(1,random.randrange(5,len(nomes))):
      ...
      for j in range(1,random.randrange(1,len(produtos))):
        data = str(random.randrange(1,28))+"-"+mes+"-2021"
