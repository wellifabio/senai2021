...
public class Pedido {
	...
	public Pedido(int id, String cliente, String endereco, String produto, Date data, Date horaPedido,
			Date horaInicioEntrega, Date horaFimEntrega) {
		this.id = id;
		this.cliente = cliente;
		this.endereco = endereco;
		this.produto = produto;
	...
	public String toHTML() {
		if (horaInicioEntrega == null) {
			...
			return "<p>" + id + "</p><p>" + cliente + "</p><p>" + endereco + "</p><p>" + produto + "</p><p>"
					+ fd.format(data) + "</p><p>" + fh.format(horaPedido) + "</p><p>" + fh.format(horaInicioEntrega)
					+ "</p>";
		} else {
			return "<p>" + id + "</p><p>" + cliente + "</p><p>" + endereco + "</p><p>" + produto + "</p><p>"
